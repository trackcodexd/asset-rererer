...
var (
	...
	ErrNoCreateItemPermission = errors.New("account does not have permissions to create items")
	ErrNoManageGroupGames     = errors.New("account does not have permissions to manage group games")
